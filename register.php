...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST['password']))){
        ...
        $password_err = "Sua senha deve possuir no mínimo 6 caracteres.";
    } else{
    ...
    if(empty(trim($_POST["confirm_password"]))){
        ...
        if($password != $confirm_password){
            $confirm_password_err = 'Senhas não combinam.';
        }
    }
...
<body>
    <div class="wrapper">
        <h2>Novo login</h2>
        <p>Preencheremos os novos dados abaixo:</p>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>Para logar, <a href="login.php">acesse aqui</a>.</p>
        </form>
    </div>
</body>
</html>
